...
# D. Dada uma lista de números retorna uma lista sem
...
# E. Cripto desafio!!
# Dada uma frase, você deve retirar todas as letras
# repetidas das palavras
